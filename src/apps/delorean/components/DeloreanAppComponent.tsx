...
export const DeloreanAppComponent: React.FC<AppProps<DeloreanInitialData>> = ({
  onClose,
  isForeground,
  skipInitialSound,
  instanceId,
        ...
        {isLoading && (
          <div className="absolute inset-0 bg-gray-100 flex items-center justify-center z-10">
            <div className="flex flex-col items-center gap-2">
              ...
              <span className="text-sm text-gray-600">Loading DeLorean...</span>
            </div>
          </div>
        )}
